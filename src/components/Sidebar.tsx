...
import {
  ...
  Settings, LogOut, Sliders, Users, SlidersHorizontal, Dumbbell, Utensils, Rocket, Bug, ArrowUpCircle, BadgeCheck, Grid3x3,
} from 'lucide-react'
...
const NAV = [
  ...
  { href: '/dashboard/upgrade-requests', icon: ArrowUpCircle,  label: 'Upgrade Requests' },
  { href: '/dashboard/cert-reviews',  icon: BadgeCheck,        label: 'Cert Reviews'    },
